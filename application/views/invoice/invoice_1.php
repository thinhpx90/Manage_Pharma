...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('manage_invoice_1') ?></h1>
            <small><?php echo display('manage_your_invoice') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('invoice_1') ?></a></li>
                <li class="active"><?php echo display('manage_invoice_1') ?></li>
            </ol>
        </div>
    </section>
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive" >
                            <table class="table table-striped table-bordered" cellspacing="0" width="100%" id="InvList_1"> 
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo ('Bác sĩ') ?></th>
                                        <th><?php echo ('Bệnh nhân') ?></th>
