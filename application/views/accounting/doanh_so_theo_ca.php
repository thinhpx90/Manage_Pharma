...
<!-- sửa đường dẫn, hàm truy vấn cho lựa chọn tìm kiếm -->
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body"> 
                        ...
                        <div class="form-group row panel-body" align="right">
                            <button type="submit" class="btn btn-success "><i class="dx-icon dx-icon-column-chooser" aria-hidden="true"></i> <?php echo('Tìm kiếm') ?></button>
                            <button type="button" class="btn btn-warning"  onclick="printDiv('printableArea')"><?php echo('In theo ngày') ?></button>
                        </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <h4>DANH SÁCH DOANH SỐ THEO CA</h4>
                    </div>
                    <div class="panel-body">
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('Tên ca') ?></th>
                                            <th class="text-center"><?php echo('Ngày') ?></th>
                                            <th class="text-center"><?php echo('Thành tiền chi') ?></th>
                                            <th class="text-center"><?php echo('Thành tiền thu') ?></th>
                                            <th class="text-center"><?php echo('Tiền thực tế') ?></th>
                                            <th class="text-center"><?php echo('Khoá ca') ?></th>
                                            <th class="text-center"><?php echo('Khoá sổ') ?></th>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="3" align="center"><b><?php echo('Tổng:') ?></b></td>
                                            <td colspan="1" align="right"><b><?php echo('Thành tiền chi??') ?></b></td>
                                            <td colspan="1" align="right"><b><?php echo('Thành tiền thu??') ?></b></td>
                                            <td colspan="1" align="right"><b><?php echo('Tiền thực tế??') ?></b></td>
                                            <td colspan="3"></td>
