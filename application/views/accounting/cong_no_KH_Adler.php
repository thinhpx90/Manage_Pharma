            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading">
                        <h4>DANH SÁCH BÁO CÁO CÔNG NỢ KH</h4>
                    </div>
                    <div class="panel-body"> 
                        ...
                        <div class="col-sm-10">
                            <div class="form-group row">
                                ...
                                <label for="customer_name" class="col-sm-2 col-form-label"><?php echo('In theo ngày') ?> <i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                                    <select name="customer_id"  class="form-control" required="">
                                        <option value=""></option>
                                       <?php foreach($customer as $customers){?>
                    ...
                    <div class="form-group row panel-body" align="right">
                            <button type="submit" class="btn btn-success col-form-label"><?php echo('In') ?></button>
                            <button type="button" class="btn btn-warning" ><?php echo('Thanh toán') ?></button>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="form-group row">
                                <label for="customer_name" class="col-sm-2 col-form-label"><?php echo('Dư đầu kì:') ?></label>
                                <i class="text-danger"><label for="customer_name" class="col-sm-2 col-form-label"><?php echo('Số liệu??') ?></label></i>
                                <label for="customer_name" class="col-sm-2 col-form-label"><?php echo('Dư cuối kì:') ?></label>
                                <i class="text-danger"><label for="customer_name" class="col-sm-2 col-form-label"><?php echo('Số liệu??') ?></label></i>
                            </div>
                    </div>
                    <div class="panel-body">
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('Tổng tiền thanh toán') ?></th>
                                            <th class="text-center"><?php echo('Công nợ') ?></th>
                                            <th class="text-center"><?php echo('Nợ có') ?></th>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="2" align="center"><b><?php echo('Tổng:') ?></b></td>
                                            <td colspan="1" align="left"><b><?php echo('Tổng tiền??') ?></b></td>
                                            <td colspan="1" align="left"><b><?php echo('Tổng tiền thanh toán??')?></b></td>
                                            <td colspan="2"></td>
