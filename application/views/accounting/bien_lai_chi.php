...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title form-group">
            <h1><?php echo('DANH SÁCH BIÊN LAI THU') ?></h1>
            <ol class="breadcrumb">
                    ...
                    <div class="panel-body"> 
                        ...
                        <div class="col-sm-10">
                            <div class="form-group row">
                                ...
                                <label for="customer_name" class="col-sm-2 col-form-label"><?php echo('Hình thức thanh toán') ?> <i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                                    <select name="customer_id"  class="form-control" required="">
                                        <option value=""></option>
                                       <?php foreach($customer as $customers){?>
                        ...
                        <div class="col-sm-10">
                            <div class="form-group row">
                                <label for="customer_name" class="col-sm-2 col-form-label"><?php echo('Trạng thái khoá sổ') ?> <i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                                    <select name="customer_id"  class="form-control" required="">
                                        <option value=""></option>
                                       <?php foreach($customer as $customers){?>
                                ...
                                <label for="customer_name" class="col-sm-2 col-form-label"><?php echo('Loại phiếu chi') ?> <i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                                    <select name="customer_id"  class="form-control" required="">
                                        <option value=""></option>
                                       <?php foreach($customer as $customers){?>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('Người nhận') ?></th>
                                            <th class="text-center"><?php echo('Số tiền trả') ?></th>
                                            ...
                                            <th class="text-center"><?php echo('Trạng thái TT online') ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td colspan="1" align="center"><b><?php echo('Số tiền thu') ?></b></td>
                                            <td colspan="4"></td>
