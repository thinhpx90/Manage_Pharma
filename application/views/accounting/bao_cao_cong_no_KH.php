<!-- Báo cáo công nợ khách hàng Start -->
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body"> 
                        ...
                        <div class="form-group row panel-body" align="right">
                            ...
                            <button type="button" class="btn btn-warning"  onclick="printDiv('printableArea')"><?php echo('In') ?></button>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('Tổng tiền hàng') ?></th>
                                            <th class="text-center"><?php echo('TT Phụ thu') ?></th>
                                            <th class="text-center"><?php echo('Giảm giá') ?></th>
                                            <th class="text-center"><?php echo('Tổng tiền phải trả') ?></th>
                                            <th class="text-center"><?php echo('Công nợ') ?></th>
                                            <th class="text-center"><?php echo('Trạng thái thanh toán') ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="3"></td>
                                            <td colspan="1" align="right"><b><?php echo('Tổng tiền hàng??') ?></b></td>
                                            <td colspan="1"></td>
