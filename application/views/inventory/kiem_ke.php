            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading">
                        <h3 class="col-sm-5" align="left">KIỂM KÊ KHO</h4>
            ...
            <!-- sửa đường dẫm và các permission tương ứng -->
                <?php if($this->permission1->method('add_customer','create')->access()){ ?>
                            ...
                            <!-- <?php if($this->permission1->method('manage_customer','read')->access()){ ?>
                                <a href="<?php echo base_url('Ccustomer/manage_customer') ?>" class="btn btn-primary m-b-5 m-r-2"><?php echo('Duyệt chứng từ') ?> </a>
                            <?php }?> -->
                    ...
                    <div class="panel-body"> 
                        ...
                        <div class="col-sm-10">
                            <div class="form-group row">
                                ...
                                <label for="customer_name" class="col-sm-2 col-form-label"><?php echo('') ?> <i class="text-danger"></i></label>
                                <div class="col-sm-4">
                    ...
                    <div class="form-group row panel-body" align="right" style="padding-right: 45px">
                            ...
                            <!-- <button type="submit" class="btn btn-success "><i class="" aria-hidden="true"></i> <?php echo('Xuất Excel') ?></button> -->
                    </div>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('Ngày kiểm kê') ?></th>
                                            <th class="text-center"><?php echo('Thời gian bắt đầu') ?></th>
                                            <th class="text-center"><?php echo('Thời gian kết thúc') ?></th>
                                            <th class="text-center"><?php echo('Số phiếu') ?></th>
                                            <th class="text-center"><?php echo('Tủ dược') ?></th>
                                            <th class="text-center"><?php echo('Thành phần kiểm kê') ?></th>
                                            <th class="text-center"><?php echo('Diễn giải') ?></th>
                                            <th class="text-center"><?php echo('Trạng thái') ?></th>
                                            <th class="text-center"><?php echo('Người duyệt') ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
