...
?>
        ...
        <div class="row">
           ...
           <?php
            ...
            <a href="<?php echo base_url('Ccustomer/manage_customer')?>" class="small-box-footer"><?php echo display('details')?> </a>
          </div>
               </div>
            <?php } ?>
            ...
            <a href="<?php echo base_url('Cmanufacturer/manage_manufacturer')?>" class="small-box-footer"><?php echo display('details')?> </a>
          </div>
                </div>
             <?php } ?>
            ...
            <a href="<?php echo base_url('Cproduct/manage_product')?>" class="small-box-footer"><?php echo display('details')?> </a>
          </div>
            </div>
           <?php } ?>
        ...
        <div class="small-box bg-orange whitecolor">
            ...
            <a href="<?php echo base_url('Creport/out_of_stock')?>" class="small-box-footer"><?php echo display('details')?> </a>
          </div>
                </div>
                <?php } ?>
                  <?php
            ...
            <a href="<?php echo base_url('Creport/out_of_date')?>" class="small-box-footer"><?php echo display('details')?> </a>
          </div>
                </div>
                <?php } ?>
                      <?php
            ...
            <a href="<?php echo base_url('Cinvoice/manage_invoice')?>" class="small-box-footer"><?php echo display('details')?> </a>
          </div>
                </div>
                <?php } ?>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                            ...
                            <div class="message_widgets">
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left"><?php echo (($position==0)?"$sales_amount $currency":"$sales_amount $currency") ?></td>
                                    </tr>
                                    <tr>
                                        <th><?php echo display('total_purchase')?></th>
                                        <td class="text-left"><?php echo (($position==0)?"$purchase_amount $currency":"$purchase_amount $currency") ?></td>
                                    </tr>
                                    <tr>
                                        <th><?php echo display('cash_received')?></th>
                                        <td class="text-left"><?php echo (($position==0)?"$total_cash_receive $currency ":"$total_cash_receive $currency") ?></td>
                                    </tr>
                                    <tr>
                                        <th><?php echo display('bank_received')?> </th>
                                        <td class="text-left"><?php echo (($position==0)?"$total_bank_receive $currency ":"$total_bank_receive $currency") ?></td>
                                    </tr>
                                   <tr>
                                        <th><?php echo display('invoice').' '.display('due')?> </th>
                                        <td class="text-left"><?php echo (($position==0)?" $total_due_amount $currency":"$total_due_amount $currency") ?></td>
                                    </tr>
                                     <tr>
                                        <th><?php echo display('total_service')?> </th>
                                        <td class="text-left"><?php echo (($position==0)?"$total_service_amount $currency ":"$total_service_amount $currency") ?></td>
                                    </tr>
             ...
             <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                ...
                <div class="panel panel-bd lobidisable">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo display('income_expense_statement_of_month')?></h4>
                        </div>
                    </div>
                    <div class="panel-body">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
               <div class="panel panel-bd lobidisable">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo display('best_sales_of_month');?></h4>
                        </div>
                    </div>
                    <div class="panel-body">
