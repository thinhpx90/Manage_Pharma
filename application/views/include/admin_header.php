...
<header class="main-header" id="main-heades">
    ...
    <nav class="navbar navbar-static-top text-center">
        ...
        if($this->permission1->method('manufacturer_payment','create')->access()){ ?>
          <a href="<?php echo base_url('accounts/manufacturer_payment')?>" class="btn btn-success btn-outline"><i class="fa fa-paypal" aria-hidden="true"></i> <?php echo display('manufacturer_payment')?></a>
        <?php } ?>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            ?>"><a href="<?php echo base_url('Cmanufacturer/manage_manufacturer') ?>"><?php echo display('manage_manufacturer') ?></a></li>
                    ...
                    <li  class="treeview <?php
            if ($this->uri->segment('2') == "manufacturer_ledger_report" || $this->uri->segment('2') == "manufacturer_ledger") {
                echo "active";
            } else {
                echo " ";
            }
            ?>"><a href="<?php echo base_url('Cmanufacturer/manufacturer_ledger_report') ?>"><?php echo display('manufacturer_ledger') ?></a></li>
                ...
                <?php if($this->permission1->method('manufacturer_advance','create')->access()){ ?>
                <li class="treeview <?php if ($this->uri->segment('2') == ("manufacturer_advance")){
                        echo "active";
                    } else {
                        echo " ";
                    }?>"><a href="<?php echo base_url('Cmanufacturer/manufacturer_advance') ?>"><?php echo display('manufacturer_advance') ?></a></li>
                  <?php } ?>
                </ul>
                </li>
                <?php
                  ...
                  <?php } ?>
                   ...
                   <li class="treeview <?php if ($this->uri->segment('2') == ("closing_report")){
                    ...
                    <li class="treeview <?php if ($this->uri->segment('2') == ("profit_manufacturer_form") || $this->uri->segment('2') == ("profit_productwise_form") || $this->uri->segment('2') == ("profit_productwise") || $this->uri->segment('2') == ("profit_manufacturer") ) { echo "active";}else{ echo " ";}?>">
                       ...
                       <li><a href="<?php echo base_url('Admin_dashboard/daily_profit')?>">Invoice Wise Report</a></li>
            ...
            <li class="treeview <?php if ($this->uri->segment('2') == ("index") || $this->uri->segment('2') == ("bank_list") || $this->uri->segment('2') == ("bank_ledger") || $this->uri->segment('2') == ("bank_transaction")) { echo "active";}else{ echo " ";}?>">
                ...
                <ul class="treeview-menu">
                    ...
                    if($this->permission1->method('add_new_bank','create')->access()){ ?>
                      <li class="treeview <?php  if ($this->uri->segment('1') == ("Csettings") && $this->uri->segment('2') == ("index") || $this->uri->segment('1') == ("Csettings") && $this->uri->segment('2') == ("bank_transaction") || $this->uri->segment('1') == ("Csettings") && $this->uri->segment('2') == ("manage_bank") || $this->uri->segment('1') == ("Csettings") && $this->uri->segment('2') == ("bank_ledger")){
                        echo "active";
                    } else {
                        echo " ";
    ...
    <!-- ========================== Expense menu end ========================== -->
     ...
     <!-- ================= Fixed Assets start ====================== -->
      ...
      <!-- Personal loan end -->
        ...
        <?php } ?>
   <!-- GPP menu start -->
              <?php if($this->permission1->method('create_gpp_register','create')->access() || $this->permission1->method('manage_gpp_register','read')->access() || $this->permission1->method('adr_register','create')->access() || $this->permission1->method('manage_adr_register','read')->access()){?>
            <!-- service menu start -->
            <li class="treeview <?php
            if ($this->uri->segment('1') == ("Cgpp")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>">
                <a href="#">
                    <i class="fa fa-asl-interpreting"></i><span><?php echo display('gpp_register') ?></span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <?php if($this->permission1->method('create_gpp_register','create')->access()){ ?>
                    <li class="treeview <?php  if ($this->uri->segment('1') == ("Cgpp") && $this->uri->segment('2') == ("")){
                        echo "active";
                    } else {
                        echo " ";
                ...
                <?php } ?>
                 <?php if($this->permission1->method('manage_gpp_register','read')->access()){ ?>
                    <li class="treeview <?php  if ($this->uri->segment('2') == ("manage_gpp_register")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('Cgpp/manage_gpp_register') ?>"><?php echo display('manage_gpp_register') ?></a></li>
                    
                      <?php } ?>
                       <?php if($this->permission1->method('adr_register','create')->access()){ ?>
                       <li class="treeview <?php  if ($this->uri->segment('2') == ("adr_register_form")){
                        echo "active";
                    } else {
                        echo " ";
                    }?>"><a href="<?php echo base_url('Cgpp/adr_register_form') ?>"><?php echo display('adr_register_form') ?></a></li>
                       <?php } ?>
                        <?php if($this->permission1->method('manage_adr_register','read')->access()){ ?>
                       <li class="treeview <?php  if ($this->uri->segment('2') == ("manage_adr_register")){
                        echo "active";
                    } else {
                        echo " ";
                    }?>"><a href="<?php echo base_url('Cgpp/manage_adr_register') ?>"><?php echo display('manage_adr_register') ?></a></li>
                       <?php } ?>
                </ul>
            </li>
        <?php } ?>
