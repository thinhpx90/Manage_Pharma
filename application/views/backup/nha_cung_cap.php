...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title form-group">
            <h1><?php echo('NHẬP DỰ TRÙ TỪ NHÀ CUNG CẤP') ?></h1>
            <ol class="breadcrumb">
    ...
    <!-- danh sách nhập dự trữ từ nhà cung cấp -->
        ...
        <div class="row">
            ...
            <!-- sửa đường dẫm và các permission tương ứng -->
                <?php if($this->permission1->method('add_customer','create')->access()){ ?>
                            ...
                            <?php }?>
                            <?php if($this->permission1->method('manage_customer','read')->access()){ ?>
                                <a href="<?php echo base_url('Ccustomer/manage_customer') ?>" class="btn btn-primary m-b-5 m-r-2"><?php echo('Nhân bản phiếu nhập') ?> </a>
                            <?php }?>
                            ...
                            <?php }?>
                            <?php if($this->permission1->method('paid_customer','read')->access()){ ?>
                                <a href="<?php echo base_url('Ccustomer/paid_customer') ?>" class="btn btn-warning m-b-5 m-r-2"><?php echo('Danh sách dự trù Excel') ?> </a>
                            <?php }?>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        ...
                        <div class="col-sm-10">
                            <div class="form-group row">
                                <label for="customer_name" class="col-sm-2 col-form-label"><?php echo('Quầy dự trữ') ?> <i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('Nơi dự trù') ?></th>
                                            <th class="text-center"><?php echo('Ngày dự trù') ?></th>
                                            <th class="text-center"><?php echo('Nhân viên') ?></th>
                                            <th class="text-center"><?php echo('Loại dự trù') ?></th>
                                            <th class="text-center"><?php echo('Trạng thái') ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
