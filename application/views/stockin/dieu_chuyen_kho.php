...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title form-group">
            <h1><?php echo('DANH SÁCH NHẬP CHUYỂN KHO') ?></h1>
            <ol class="breadcrumb">
        ...
        <div class="row">
            ...
            <!-- sửa đường dẫm và các permission tương ứng -->
                <?php if($this->permission1->method('add_customer','create')->access()){ ?>
                                <a href="<?php echo('Thêm mới') ?>" class="btn btn-info m-b-5 m-r-2"><?php echo('Nhập từ chứng từ xuất') ?> </a>
                            <?php }?>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('Số phiếu xuất') ?></th>
                                            <th class="text-center"><?php echo('Kho xuất') ?></th>
