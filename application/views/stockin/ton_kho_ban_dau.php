...
<!-- fix this data area -->
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="5" align="center"><b><?php echo('Giá trị kho') ?></b></td>
                                            <td colspan="1" align="right"><b><?php echo('Tổng tiền') ?></b></td>
                                            <td colspan="1" align="right"><b><?php echo('Thành tiền bán') ?></b></td>
                                            <td colspan="1" align="right"><b><?php echo('Lợi nhuận:') ?></b></td>
                                            <td colspan="1" align="center"><b><?php echo('LN?') ?></b></td>
