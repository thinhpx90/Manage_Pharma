        ...
        <div class="row">
            ...
            <!-- sửa đường dẫm và các permission tương ứng -->
                <?php if($this->permission1->method('add_customer','create')->access()){ ?>
                            ...
                            <?php }?>
                            <?php if($this->permission1->method('manage_customer','read')->access()){ ?>
                                <a href="<?php echo base_url('Ccustomer/manage_customer') ?>" class="btn btn-primary m-b-5 m-r-2">  <?php echo('Chi trả / thu tiền') ?> </a>
                            <?php }?>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        ...
                        <div class="col-sm-10">
                            <div class="form-group row">
                                <label for="customer_name" class="col-sm-2 col-form-label"><?php echo('Nhà cung cấp') ?> <i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                                ...
                                <label for="customer_name" class="col-sm-2 col-form-label"><?php echo('Trạng thái chiết khấu') ?> <i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                                    <select name="customer_id"  class="form-control" required="">
                                        <option value=""></option>
                                       <?php foreach($customer as $customers){?>
                        ...
                        <div class="col-sm-10">
                            <div class="form-group row">
                                ...
                                <label for="customer_name" class="col-sm-2 col-form-label"><?php echo('Trạng thái thanh toán') ?> <i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                                    <select name="customer_id"  class="form-control" required="">
                                        <option value=""></option>
                                       <?php foreach($customer as $customers){?>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('Nhà cung cấp') ?></th>
                                            <th class="text-center"><?php echo('Số chứng từ') ?></th>
                                            <th class="text-center"><?php echo('Tổng tiền') ?></th>
                                            <th class="text-center"><?php echo('T.Tiền CK') ?></th>
                                            <th class="text-center"><?php echo('T.Tiền T.Toán') ?></th>
                                            <th class="text-center"><?php echo('T.Tiền đã T.Toán') ?></th>
                                            <th class="text-center"><?php echo('Công nợ') ?></th>
                                            <th class="text-center"><?php echo('T.Thái T.Toán') ?></th>
                                            <th class="text-center"><?php echo('Trạng thái') ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td colspan="2" align="center"><b><?php echo('Tổng tiền') ?></b></td>
                                            <td colspan="1" align="right"><b><?php echo('T.Tiền T.Toán') ?></b></td>
                                            <td colspan="2"></td>
                                            <td colspan="1" align="right"><b><?php echo('Công nợ') ?></b></td>
                                            <td colspan="1"></td>
