                        ...
                        <div class="panel-body">
                            ...
                            <div class="row" id="manufacturer_info">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="manufacturer_id" class="form-control" required="required" tabindex="12" id="">
                                                ...
                                                ?>
                                                        <option value="<?php echo $manufac['manufacturer_id'] ?>" <?php if ($manufacturer_id == $manufac['manufacturer_id']) {
                                                                                                                        echo "selected";
                                ...
                                <div>
                                    <div class="form-group row">
                                        <div>
                                            <div style="display: flex;justify-content: space-between; align-items: center; width: 100%; flex-direction: row; padding: 40px">
                                                    <label><input type="checkbox" value="">QL số lô</label>
                                        
                                            
                                                    <label><input type="checkbox" value="">QL Hạn dùng</label>
                                                
                                                
                                                    <label><input type="checkbox" value="">Gửi BYT</label>
                                                
                                                
                                                    <label><input type="checkbox" value="">Hiển thị trên web</label>
