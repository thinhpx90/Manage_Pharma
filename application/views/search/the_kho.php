                    ...
                    <div class="panel-body"> 
                        ...
                        <div class="col-sm-10">
                            <div class="form-group row">
                                <label for="from_date " class="col-sm-2 col-form-label"> <?php echo('Ngày từ') ?><i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                                    <input type="text" name="from_date"  value="<?php echo (!empty($start)?$start:$today); ?>" class="datepicker form-control" id="from_date"/>
                                </div>
                                <label for="to_date" class="col-sm-2 col-form-label"> <?php echo('Ngày đến') ?><i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group row">
                                <label for="customer_name" class="col-sm-2 col-form-label"><?php echo('Loại hiển thị') ?> <i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                                ...
                                <label for="customer_name" class="col-sm-2 col-form-label"><?php echo('Dược') ?> <i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                                    <select name="customer_id"  class="form-control" required="">
                                        <option value=""></option>
                                       <?php foreach($customer as $customers){?>
            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading" style="">
                        <h4 class="col-sm-6" align="left">THẺ KHO</h4>
