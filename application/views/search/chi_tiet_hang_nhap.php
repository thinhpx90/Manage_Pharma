            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    ...
                    <div class="panel-body"> 
                        ...
                        <div class="col-sm-10">
                            <div class="form-group row">
                                ...
                                <label for="customer_name" class="col-sm-2 col-form-label"><?php echo('Loại phiếu nhập') ?> <i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                                    <select name="customer_id"  class="form-control" required="">
                                        <option value=""></option>
                                       <?php foreach($customer as $customers){?>
                    ...
                    <div class="form-group row panel-body" align="right">
                            ...
                            <button type="submit" class="btn btn-success "><?php echo('In tem') ?></button>
                            <button type="submit" class="btn btn-success "><?php echo('Sổ kiểm nhập') ?></button>
                        </div>
                </div>
            </div>
        </div>
...
<!-- fix this data area -->
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('Tiền thanh toán') ?></th>
                                            <th class="text-center"><?php echo('TT Dự trù bán') ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading" style="">
                        <h4 class="col-sm-6" align="left">LỊCH SỬ NHẬP</h4>
                        <br>
                    </div>
                    <div class="panel-body">
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('ĐV nhập') ?></th>
                                            <th class="text-center"><?php echo('SL nhập') ?></th>
                                            <th class="text-center"><?php echo('TL Quy đổi') ?></th>
                                            <th class="text-center"><?php echo('Đơn vị') ?></th>
                                            <th class="text-center"><?php echo('Số lượng') ?></th>
                                            <th class="text-center"><?php echo('Thành tiền') ?></th>
                                            <th class="text-center"><?php echo('Thành tiền (VAT)') ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
