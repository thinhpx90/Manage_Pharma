            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    ...
                    <div class="panel-body"> 
                        ...
                        <div class="col-sm-10">
                            <div class="form-group row">
                                <label for="customer_name" class="col-sm-2 col-form-label"><?php echo('Nhóm dược') ?> <i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                                ...
                                <label for=""> Theo lô, hạn</label><br>
                                <input type="checkbox" id="" name="" value="">
                                <label for=""> Tách phân loại nhập</label><br>
                            </div>
                        </div>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('Tên thuốc - VTYTHC') ?></th>
                                            <th class="text-center"><?php echo('Đơn vị') ?></th>
                                            <th class="text-center"><?php echo('Đơn giá xuất') ?></th>
                                            <th class="text-center"><?php echo('Đơn giá nhập') ?></th>
