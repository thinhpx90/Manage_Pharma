            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    ...
                    <div class="panel-body"> 
                        ...
                        <div class="col-sm-10">
                            <div class="form-group row">
                                <label for="customer_name" class="col-sm-2 col-form-label"><?php echo('Kho xuất') ?> <i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                                ...
                                <label for="customer_name" class="col-sm-2 col-form-label"><?php echo('Loại phiếu dự trù') ?> <i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                                    <select name="customer_id"  class="form-control" required="">
                                        <option value=""></option>
                                       <?php foreach($customer as $customers){?>
                ...
                <div class="panel panel-bd">
                    <div class="panel-heading" style="">
                        ...
                        <div class="col-sm-6" align="right">
                            <button type="submit" class="btn btn-success col-form-label"><?php echo('Xuất Excel') ?></button>
                        </div>
                        <br>
                        <br>
                    </div>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('SL yêu cầu') ?></th>
                                            <th class="text-center"><?php echo('SL thực nhận') ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
