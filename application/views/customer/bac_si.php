...
<!-- sửa đường dẫn, hàm truy vấn cho lựa chọn tìm kiếm -->
            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading">
                        <h3 class="col-sm-5" align="left">Danh sách bác sĩ</h4>
        ...
        <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" name ="amount" id="amount" type="text"  required min="0" tabindex="3">
                                 </div>
                                </div>
                            </div>
        <!-- <style>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('Mã bác sĩ') ?></th>
                                            <th class="text-center"><?php echo('Tên bác sĩ') ?></th>
