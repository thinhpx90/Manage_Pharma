...
<html dir="ltr" lang="en">
    <head>
        ...
        <title><?php echo (isset($title)) ? html_escape($title) : "Online & Offline Inventory System" ?></title>
      ...
      <link href="<?php echo base_url()?>assets/plugins/modals/component.css" rel="stylesheet" type="text/css"/>
        ...
        <!-- summernote css -->
           <link href="<?php echo base_url()?>assets/css/styleBD.min.css" rel="stylesheet" type="text/css"/>
